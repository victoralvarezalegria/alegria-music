...
// Ported verbatim from victor-site-handoff/funnel/watch.html.
...
export const metadata: Metadata = {
  ...
  description: "A free on-demand masterclass for serious brass players. Unlock the high register, win auditions, end stage fright, without adding a single hour of practice. With Victor Alegria. Watch it whenever you want.",
};
...
<div class="hero">
    <!-- ON-DEMAND copy of index.html (2026-09-08). Same page, same promise,
         minus the live-event framing: no date, no seat cap, no reminder.
         Sign-up lands straight on the /masterclass viewing room and the
         contact goes on AC list 10 "Automated Masterclass Leads", NOT list 5, so the
         live countdown automation never fires for them.
         Promise copied VERBATIM from slide 1 of the masterclass deck, so the ad,
         this page, and the masterclass's opening slide all make the same promise. -->
    <div class="eyebrow">A Free Masterclass For Serious Brass Players</div>
    <h1>
...
<div class="cols">
    ...
    <div class="col-copy">
        <div class="lead">FREE ON-DEMAND TRAINING WITH VICTOR ALEGRIA:</div>
...
<div class="overlay" id="popup">
    <div class="modal">
        ...
        <p class="sub">The 1% Method: a free masterclass with Victor Alegria, Principal Trombone of the Helsinki Philharmonic. The video opens the moment you sign up.</p>
        <form id="regForm">
        ...
        <p class="fine">No spam, ever. Unsubscribe any time.</p>
    </div>
</div>`;
...
/* On-demand: skip the date page and land straight on the viewing room.
   No .html: vercel.json sets cleanUrls, so /masterclass.html 308s to /masterclass. */
var THANK_YOU_PAGE = "/masterclass";
/* Tells /api/subscribe to use the on-demand list (AC list 10), not the live
   registration list (5) whose automation sends the countdown emails. */
var REGISTRATION_SOURCE = "ondemand";
